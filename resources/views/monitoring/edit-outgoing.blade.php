...
@section('title', 'Edit Outgoing Transaction - ' . $document->misd_code)
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">Edit Outgoing Transaction</li>
@endsection

@section('content')
    <div class="page-header">
        <h1><i class="bi bi-pencil"></i> Edit Outgoing Transaction</h1>
